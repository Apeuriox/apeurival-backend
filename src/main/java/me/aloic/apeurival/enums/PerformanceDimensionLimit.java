...
public enum PerformanceDimensionLimit
{
    ...
    FLOW("flow", 400.0, 5500.0, 8000.0,0.691,1.12),
    SPEED("speed", 800.0, 5500.0, 7500.0,1.109,1.01),
    STAMINA("stamina", 500.0, 300.0, 6200.0,0.993,0.99),
    PRECISION("precision", 300.0, 3700.0, 6000.0,0.741,1.00),
    ACCURACY("accuracy", 600.0, 3000.0, 4000.0,0.891,1.25),
    AVERAGE("average", 200.0, 5500.0, 7800.0,0.811,1.0);
